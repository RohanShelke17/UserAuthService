  ...
  return (
    <div className="d-flex align-items-center justify-content-center vh-100 position-relative" style={{background: "linear-gradient(90deg,#6a5af9,#8268f9)",border:"none"}}>
      ...
      {!isOtpSubmitted && isEmailSent && (
        ...
        <button className="btn btn-primary w-100 fw-semibold" disabled={loading} onClick={handleVerify}>{loading ? "Verifying..." : "Verify email"}</button>
          ...
          {isOtpSubmitted && isEmailSent && (
            <div className="rounded-4 p-4 text-center bg-white" style={{width:'100%',maxWidth:'400px'}}>
              ...
              <form onSubmit={onSubmitNewPassword}>
                ...
                <button type="submit" className="btn btn-primary w100" disabled={loading}>{loading?"Loading":"Submit"}</button>
              </form>
            </div>
          )}
